...
### UI Access 
Fusion User Interfaces available on http://localhost:8083 for HDP Zone and http://localhost:8583 for ADLS Gen2 Zone2 with default username and password admin/admin.
