...
1. Hortonworks HDP 2.6.5 Cluster, CDH 5.13 Cluster or ADLS Gen 1 cluster
...
1. [Download](https://github.com/WANdisco/fusion-docker-compose/archive/master.zip) and unzip the configuration files. 
