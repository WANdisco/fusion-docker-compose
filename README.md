...
1. Download, unzip and modify the configuration files under `fusion-shared-a` and `fusion-shared-b`
```wget 
https://github.com/WANdisco/fusion-docker-compose/archive/master.zip
```
